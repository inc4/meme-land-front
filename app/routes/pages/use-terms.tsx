const UseTerms = () => (
  <div className="static-page">
    <p>IMPORTANT — PLEASE READ THIS LEGAL NOTICE IN FULL. NOTHING ON THIS SITE CONSTITUTES LEGAL, FINANCIAL, BUSINESS, OR TAX ADVICE. BEFORE ENGAGING WITH THIS WEBSITE OR THE MEMEDROP PLATFORM, SEEK GUIDANCE FROM QUALIFIED PROFESSIONAL ADVISERS. NEITHER STKLYER INC, ITS FOUNDERS, DEVELOPERS, NOR ANY SERVICE PROVIDER SHALL BE LIABLE, TO THE MAXIMUM EXTENT PERMITTED BY LAW, FOR ANY DIRECT, INDIRECT, INCIDENTAL, CONSEQUENTIAL, OR OTHER LOSS OR DAMAGE ARISING FROM OR IN CONNECTION WITH YOUR ACCESS TO THIS WEBSITE, YOUR USE OF OR RELIANCE ON ANY TOKENS, OR ANY OTHER MATERIALS WE PUBLISH.</p>
    <h3>RISK WARNING & LEGAL DISCLAIMER (PLEASE READ CAREFULLY)</h3>
    <p>
    ...
    <p>
      LEGAL DISCLAIMER: Memedrop is a platform for launching and participating in memecoin-related presales. Tokens launched or accessed through Memedrop may have no intrinsic value, no guaranteed utility, and should be considered high-risk digital assets. Any community features or benefits associated with these tokens are experimental and subject to change. Conduct thorough research. By interacting with any token via Memedrop, you acknowledge and accept the risk of total loss.
    </p>
    <p>
      Access to this website is not intended for residents of countries or territories subject to sanctions, bans, or regulatory restrictions, including but not limited to: Afghanistan, Iran, North Korea, Syria, Cuba, Crimea, the United States of America, and others. You are responsible for complying with all local laws. By accessing this website, you confirm that you are not a resident of a restricted region and are not using VPNs or proxy services to conceal your location.
    </p>
    <ol>
      <li>
    ...
    <p>
      By using the Services—including browsing, sharing, interacting with launches, or submitting information—you agree to be bound by these Terms. If you do not agree to these Terms in full, you must not use the Services.
    </p>
    <ol start={2}>
      <li>
    ...
    <ul>
      <li>You are not located in or a resident of a restricted jurisdiction.</li>
      <li>You are not subject to economic sanctions.</li>
