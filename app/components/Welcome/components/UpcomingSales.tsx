...
const UpcomingSales = () => {
  return (
    <section>
      <h2 className="text-white text-[38px] font-bold">More Upcoming Sales</h2>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-8">
        <div className="bg-[#0F1113] rounded-[14px] py-4 px-5 flex flex-col min-h-[502px]">
          ...
          <span className="text-white text-sm opacity-60 mb-4">ZAI</span>
          <span className="text-white text-sm opacity-60">Zesh AI Layer is an AI Layer on SUI, with 1.6M+ users.For a chance to participate in this crypto IDO please check the pre-sale details below.</span>
