      ...
      <div>
        <div
          ...
          <div className="text-lg flex justify-between items-center">
            ...
            <span className="font-medium font-mono">${isLoading ? "-" : '1.00'}</span>
          </div>
          <div className="text-lg flex justify-between items-center">
            <span className="font-semibold lg:font-bold text-h4">Listing Multiplier</span>
            <span className="font-medium text-[#9D85FF] font-mono ">X{isLoading ? "-" : '3.1'}</span>
          </div>
          <div className="text-lg flex justify-between items-center">
            <span className="font-semibold lg:font-bold text-h4">Listing price</span>
            <span className="font-medium text-[#12F287] font-mono">${isLoading ? "-" : '3.1'}</span>
          </div>
          <div className="text-lg flex justify-between items-center">
            <span className="font-semibold lg:font-bold text-h4">Profit Chance</span>
            <span className="font-medium text-[#FFA544] font-mono">{isLoading ? "-" : '45.5'}%</span>
          </div>
        </div>
